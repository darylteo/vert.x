...
import vertx.tests.core.shareddata.LocalSharedDataTest;

/**
 * @author <a href="http://tfox.org">Tim Fox</a>
 */
public class JavaLocalSharedDataTest extends TestBase {
  @Override
  ...
  protected void startApp() throws Exception {
    super.startApp(LocalSharedDataTest.class.getName());
  }
